...
const account0 = '0xDF7DDE3441149D03078656886b2AF7EdfbE66c5D';
...
const mintDai = async () => {
  ...
  try{
    ...
    await daiInstance.methods.mint(account0, numDaiToMint).send({from: daiOwner, gasPrice: web3.utils.toHex(0)});
    const daiOnAccount0 = await daiInstance.methods.balanceOf(account0).call();
